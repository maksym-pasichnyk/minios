...
static int do_conversion_int (unsigned long long val, int f, int width, int precision, int (*func)(int c, void *data), void *data) {
	int len = 0;
	int n = 0;
...
static int do_conversion_string (const char *str, int f, int width, int precision, int (*func)(int c, void *data), void *data) {
	int len;
	int n = 0;
...
int vprintf (const char *format, va_list ap) {
	return do_printf (format, ap, do_putchar, NULL);
}
